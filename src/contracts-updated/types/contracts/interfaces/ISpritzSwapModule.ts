...
export interface ISpritzSwapModuleInterface extends utils.Interface {
  functions: {
...
export interface ISpritzSwapModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISpritzSwapModuleInterface;
