...
export interface UniswapV3ModuleInterface extends utils.Interface {
  functions: {
...
export interface UniswapV3Module extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV3ModuleInterface;
