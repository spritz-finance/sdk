...
export interface SpritzV2SwapModuleInterface extends utils.Interface {
  functions: {
...
export interface SpritzV2SwapModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpritzV2SwapModuleInterface;
