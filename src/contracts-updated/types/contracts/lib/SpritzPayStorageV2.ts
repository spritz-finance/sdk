...
export interface SpritzPayStorageV2Interface extends utils.Interface {
  functions: {
...
export interface SpritzPayStorageV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpritzPayStorageV2Interface;
