...
export interface SpritzPayStorageV3Interface extends utils.Interface {
  functions: {
...
export interface SpritzPayStorageV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpritzPayStorageV3Interface;
