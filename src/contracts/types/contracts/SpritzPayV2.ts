...
export interface SpritzPayV2Interface extends utils.Interface {
  functions: {
    ...
    "payWithTokenSubscription(address,address,uint256,bytes32)": FunctionFragment;
    "payWithV3Swap(bytes,address,uint256,address,uint256,bytes32,uint256)": FunctionFragment;
    ...
    "setSmartPayAddress(address)": FunctionFragment;
    "setV3SwapTarget(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "payWithTokenSubscription",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "payWithV3Swap",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "setSmartPayAddress",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "setV3SwapTarget",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface SpritzPayV2 extends BaseContract {
  ...
  functions: {
    ...
    setSmartPayAddress(
      swapPayAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
