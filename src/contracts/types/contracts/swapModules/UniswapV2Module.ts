...
export interface UniswapV2ModuleInterface extends utils.Interface {
  functions: {
...
export interface UniswapV2Module extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV2ModuleInterface;
