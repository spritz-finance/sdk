...
export interface SpritzPay_LegacyInterface extends utils.Interface {
  functions: {
...
export interface SpritzPay_Legacy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpritzPay_LegacyInterface;
